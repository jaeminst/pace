...
// fakeClock is a Clock frozen at one instant. ExampleLimitError asserts on an
// exact string, and Delay is measured at the point of failure — against the
// wall clock, half a second of scheduling anywhere between the two calls turns
// "10s" into "9s", and an Example compares stdout with no tolerance band.
