...
//
// Implement [Backend] against a backend every process consults — Redis, a
// database, anything that can decrement a counter atomically — and supply it as
// [github.com/jaeminst/pace/config.Config.Shared]. The local bucket stays, as a
...
//
// Read [Backend] and [ErrorPolicy] before adopting this. Most callers who want
